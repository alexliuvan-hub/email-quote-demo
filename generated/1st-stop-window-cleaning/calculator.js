/**
 * 1st Stop Window Cleaning — quote pricing (adapted from BrightPath calculator logic)
...
export function calculateQuote(tier, addOns = {}) {
  const disclaimer =
    'Demo estimate only — sample rates for 1st Stop Window Cleaning. Final price may vary after an on-site assessment.';
