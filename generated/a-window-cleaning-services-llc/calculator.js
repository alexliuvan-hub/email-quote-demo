/**
 * A+ Window Cleaning Services LLC — quote pricing (adapted from BrightPath calculator logic)
...
export function calculateQuote(tier, addOns = {}) {
  const disclaimer =
    'Demo estimate only — sample rates for A+ Window Cleaning Services LLC. Final price may vary after an on-site assessment.';
