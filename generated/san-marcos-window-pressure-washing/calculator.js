/**
 * San Marcos Window & Pressure Washing — quote pricing (adapted from BrightPath calculator logic)
...
export function calculateQuote(tier, addOns = {}) {
  const disclaimer =
    'Demo estimate only — sample rates for San Marcos Window & Pressure Washing. Final price may vary after an on-site assessment.';
