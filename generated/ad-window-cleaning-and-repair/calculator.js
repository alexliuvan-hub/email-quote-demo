/**
 * A&D Window Cleaning and Repair — quote pricing (adapted from BrightPath calculator logic)
...
export function calculateQuote(tier, addOns = {}) {
  const disclaimer =
    'Demo estimate only — sample rates for A&D Window Cleaning and Repair. Final price may vary after an on-site assessment.';
