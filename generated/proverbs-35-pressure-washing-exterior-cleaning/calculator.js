/**
 * Proverbs 3:5 Pressure Washing & Exterior Cleaning — quote pricing (adapted from BrightPath calculator logic)
...
export function calculateQuote(tier, addOns = {}) {
  const disclaimer =
    'Demo estimate only — sample rates for Proverbs 3:5 Pressure Washing & Exterior Cleaning. Final price may vary after an on-site assessment.';
