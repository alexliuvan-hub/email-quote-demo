/**
 * Clear Choice Window Cleaning & Pressure Washing — quote pricing (adapted from BrightPath calculator logic)
...
export function calculateQuote(tier, addOns = {}) {
  const disclaimer =
    'Demo estimate only — sample rates for Clear Choice Window Cleaning & Pressure Washing. Final price may vary after an on-site assessment.';
