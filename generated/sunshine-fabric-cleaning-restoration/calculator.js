/**
 * Sunshine Fabric Cleaning & Restoration — quote pricing (adapted from BrightPath calculator logic)
...
export function calculateQuote(tier, addOns = {}) {
  const disclaimer =
    'Demo estimate only — sample rates for Sunshine Fabric Cleaning & Restoration. Final price may vary after an on-site assessment.';
