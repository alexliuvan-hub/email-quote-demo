/**
 * Crystal Clear Window Cleaning — quote pricing (adapted from BrightPath calculator logic)
...
export function calculateQuote(tier, addOns = {}) {
  const disclaimer =
    'Demo estimate only — sample rates for Crystal Clear Window Cleaning. Final price may vary after an on-site assessment.';
